...
# CFD runs
filename0 = 'surface_flowG0_Lim0.1_AoA10.csv'
filename1 = 'surface_flowG1_Lim0.1_AoA10.csv'
filename2 = 'surface_flowG2_Lim0.1_AoA10.csv'
filename3 = 'surface_flowG3_Lim0.1_AoA10.csv'
filename4 = 'surface_flowG4_Lim0.1_AoA10.csv'
...
fig.savefig('Cp_vs_Grid_Lim_0_1_deg10.pdf')
plt.show()

...
# CFD runs
filename0 = 'surface_flowG2_Lim0.1_AoA15.csv'
filename1 = 'surface_flowG2_Lim1_AoA15.csv'
filename2 = 'surface_flowG2_Lim10_AoA15.csv'
...
fig.savefig('Cp_vs_Lim_G2_deg15.pdf')
plt.show()
